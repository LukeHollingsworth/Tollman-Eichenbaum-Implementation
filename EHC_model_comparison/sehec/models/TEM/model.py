...
class TEM(NeuralResponseModel):
    ...
    def update(self, obs, d, it_num, seq_index, it_index):
        ...
        if it_num % self.pars['save_interval'] == 0 and it_num > 0:
            self.save_ticker = True
        if it_num % self.pars['save_model'] == 0:
            self.save_model = True
        if it_num % self.pars['sum_int'] == 0:
        ...
        if seq_index == self.n_walk - 1:
            self.save_and_plot(it_num, a_rnn, a_rnn_inv)
